          ...
          >
            <div
              ...
              style={{
                ...
                background: "linear-gradient(135deg, rgba(239,159,39,0.12) 0%, rgba(239,159,39,0.04) 100%)",
              }}
            >
              {/* Badge top */}
              <div
              ...
              <div className="p-6 md:p-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p
                        ...
                        style={{ color: "var(--rp-cta-hover)", fontFamily: "var(--font-jakarta), sans-serif" }}
                      >
                        {promo.title}
                      </p>
                      <p
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          ...
                          style={{ background: "rgba(15,110,86,0.1)", color: "var(--rp-primary)" }}
                        >
                          HEMAT
                        </span>
                      </div>
                      <p className="text-xs mt-2" style={{ color: "var(--rp-gray-text)" }}>
                        {promo.disclaimer}
                      </p>
                    </div>
                  </div>

                  {/* Right: CTA + timer icon */}
                  <div className="flex flex-col items-center gap-3 shrink-0">
                    <div className="flex items-center gap-1.5 text-xs" style={{ color: "var(--rp-gray-text)" }}>
                      <Clock size={13} />
                    ...
                    <Link
                      ...
                      className="px-5 py-3 rounded-xl font-semibold text-white transition-all hover:scale-105 hover:shadow-xl flex items-center gap-2 text-sm"
                      style={{ background: "var(--rp-cta)" }}
                    >
                ...
                {/* Bottom notes */}
                <div
                  className="mt-5 pt-4 text-center text-xs space-y-1"
                  style={{ borderTop: "1px solid rgba(239,159,39,0.15)", color: "var(--rp-gray-text)" }}
                >
                  <p>{promo.smallNote}</p>
                  <p>{promo.quotaNote}</p>
                </div>
